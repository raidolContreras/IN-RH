...
(6, 'curriculum', 16, '2023-06-23 16:14:18'),
(7, 'curriculum', 17, '2023-06-23 16:22:40');
...
INSERT INTO `empleados_has_permisos` (`idEm_has_Per`, `fechaPermiso`, `fechaFin`, `descripcion`, `statusPermiso`, `Empleados_idEmpleados`, `Permisos_idPermisos`) VALUES
(3, '2023-06-26', '2023-06-29', '', 1, 6, 6),
(4, '2023-06-28', '2023-06-28', 'asd', 1, 3, 5),
(5, '2023-07-27', '2023-07-28', '', 2, 6, 5);
...
(1, 'L-S 9:00 a 18:00', 1),
(2, 'L-V 8:00 a 17:00', 0);
...
(9, 'Etiquetador', 10000000, 50000, 20, 50, 1),
...
--
ALTER TABLE `asistencias`
  MODIFY `idAsistencias` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
