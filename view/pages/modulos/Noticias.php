<div class="container-fluid dashboard-content">
  <form method="POST"enctype="multipart/form-data">
    ...
    <!---->
    <textarea class="form-control noticia_text" name="mensaje_noticia" id="mensaje_noticia" rows="3" required></textarea>
...
<script>
  $(document).on("DOMContentLoaded", function() {
    // Por defecto, ocultar el botón "Seleccionar imagen"
    $("#image_upload").hide();
    ...
    $("#requiere_foto").change(function() {
      if ($(this).is(":checked")) {
        // Mostrar el botón "Seleccionar imagen" si el checkbox está marcado
        $("#image_upload").show();
        // Establecer el valor del campo oculto "foto_noticia" como 1
        $("#foto_noticia").val(1);
      } else {
        // Ocultar el botón "Seleccionar imagen" si el checkbox no está marcado
        $("#image_upload").hide();
