<?php if (!empty($rol) && $rol['Ver_Reclutamiento'] == 1) : ?>
	<?php
	$vacantes = ControladorFormularios::ctrVerVacantes(null, null);
	$i = 0;
	?>
				...
				<div class="card">
					<div class="card-body">
						<?php if (!empty($rol) && $rol['Editar_Reclutamiento'] == 1) : ?>
							<a href="Vacantes-CrearVacante" class="btn btn-success p-2 rounded mb-3 float-right">
									...
									<?php foreach ($vacantes as $key => $vacante) :
										...
										if ($activacion == 1) :
											if ($vacante['aprobado'] != 2) :
												if ($rol['General_Reclutamiento'] == 1) : ?>
													<tr>
																...
																<?php if (!empty($rol) && ($rol['Editar_Reclutamiento'] == 1 || $rol['Del_Reclutamiento'] == 1)) : ?>
																	<div class="dropdown">
																		...
																		<div class="dropdown-menu mr-0" aria-labelledby="dropdownMenuButton">
																			<?php if (!empty($rol) && $rol['Editar_Reclutamiento'] == 1) : ?>
																				<a class="dropdown-item" href="Vacantes-CrearVacante&Editar=<?php echo $vacante['idVacantes'] ?>">
																					<i class="fas fa-edit"></i> Editar
																				</a>
																			<?php endif ?>
																			<?php if (!empty($rol) && $rol['Del_Reclutamiento'] == 1) : ?>
																				<a class="dropdown-item" href="Vacantes-EliminarVacante&Eliminar=<?php echo $vacante['idVacantes'] ?>">
												...
												<?php elseif ( $_SESSION['idEmpresas'] == $vacante['idEmpresaV']): ?>
													<tr>
														<td><?php echo $vacante['nameVacante'] ?></td>
														<td><?php echo $vacante['nombre_razon_social'] ?></td>
														<td><?php echo $vacante['nameDepto'] ?></td>
